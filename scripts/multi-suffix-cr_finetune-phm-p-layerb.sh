TOTAL_NUM_UPDATES=5547	 	# 10 epochs through RTE for bsz 16
WARMUP_UPDATES=299	     	# 6 percent of the number of updates
...
CUDA_VISIBLE_DEVICES=$node fairseq-train cr-bin/ \
