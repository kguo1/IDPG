TOTAL_NUM_UPDATES=26894	 	# 10 epochs through RTE for bsz 16
WARMUP_UPDATES=291	     	# 6 percent of the number of updates
...
CUDA_VISIBLE_DEVICES=$node fairseq-train mpqa-bin/ \
